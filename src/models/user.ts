...
export const associate = (db: dbType) => {
    ...
    db.User.hasMany(db.ReportedBoard, {onDelete: "CASCADE", onUpdate: "CASCADE", hooks: true});
    db.User.hasMany(db.ReportedComment, {onDelete: "CASCADE", onUpdate: "CASCADE", hooks: true});
};
